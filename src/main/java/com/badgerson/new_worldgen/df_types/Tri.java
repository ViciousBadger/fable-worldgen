...
public record Tri(DensityFunction df) implements DensityFunctionTypes.Unary {
    ...
    private static final MapCodec<Tri> MAP_CODEC = RecordCodecBuilder.mapCodec((instance) -> instance.group(DensityFunction.FUNCTION_CODEC.fieldOf("argument").forGetter(Tri::df)).apply(instance, (Tri::new)));
